...
export interface ColorInfo {
  hex: string;      // For CSS/HTML (e.g., "#f34b7d")
  numeric: number;  // For Three.js (e.g., 0xf34b7d)
 ...
 */
export const FILE_COLORS: Record<string, ColorInfo> = {
 ...
 */
export const DEFAULT_COLOR: ColorInfo = {
  hex: '#aaaaaa',
  numeric: 0xaaaaaa,
  name: 'Unknown'
};
 ...
 */
export const DIRECTORY_COLOR: ColorInfo = {
  hex: '#7f8c8d',
  numeric: 0x7f8c8d,
  name: 'Directory'
};
 ...
 */
export function getColorForExtension(ext: string): ColorInfo {
